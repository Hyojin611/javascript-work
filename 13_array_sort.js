...
// 1. sort() : 오름차순 정렬, 원본 수정 함.
console.log('1. sort()');
iveMember.sort();
console.log(iveMember);


// 2. reverse() : 내림차순 정렬, 원본 수정 함.
console.log('2. reverse()');
iveMember.reverse();
console.log(iveMember);

// 3. 숫자 배열의 정렬
let number =[1, 9, 71, 5, 13];
console.log('3. 숫자 배열의 정렬');
// 오름차순 정렬
number.sort((x,y)=>{
  return x - y;
  // = return x > y ? 1 : -1;
...
// 정수에 대해서 오름차순 정렬 (점수 높은 값부터)
console.log('정수에 대해서 오름차순 정렬');
data.sort((x , y)=>{
  return y.score - x.score;
})
console.log(data);

// 정수에 대해서 내림차순 정렬 (점수 낮은 값부터)
console.log('정수에 대해서 내림차순 정렬');
data.sort((x , y) => {
